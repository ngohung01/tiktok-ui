...
const QRIcon = ({ height = '2rem', width = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
const AuthIcon = ({ height = '2rem', width = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
const GoggleIcon = ({ height = '2rem', width = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
const LineIcon = ({ height = '2rem', width = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
const KakaoTalkIcon = ({ height = '2rem', width = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
const InsIcon = ({ width = '2rem', height = '2rem' }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
